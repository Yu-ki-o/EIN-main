#!/usr/bin/env python3
"""Seed-0 key-parameter sweep for Pheme BiGCN UncertaintySemanticChange.
...
DEFAULTS = {
    ...
    / "configs/sweeps/pheme_bigcn_uncertainty_semantic_change_keyparams_seed0",
    "output_dir": REPO_ROOT
    / "experiments/EIN/Pheme/sweep_pheme_bigcn_uncertainty_semantic_change_keyparams_seed0",
    "result_group": "sweep_pheme_bigcn_uncertainty_semantic_change_keyparams_seed0",
    "sweep_name_prefix": "sweep_pheme_bigcn_uncertainty_semantic_change_keyparams",
    ...
    "extra_preset_grids": {
        ...
        "semantic_tree_core": {
            ...
            "semantic_tree_transformer_dropout": [0.1, 0.2, 0.3],
            "semantic_tree_transformer_max_depth": [24, 47],
        },
        "semantic_tree_capacity": {
            "semantic_tree_transformer_heads": [2, 4],
            "semantic_tree_transformer_ffn_dim": [128, 256],
            "semantic_tree_depth_dim": [32, 64],
